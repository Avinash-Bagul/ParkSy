...
import { createSpace, getSpace, updateSpace, deleteSpace, confirmPayment, getSingleSpace } from '../controllers/Spaces.js';
import authMiddleware from '../middlewares/authMiddleware.js';

const router = Router();

router.get("/", getSpace);
router.get("/getSingpleSpace/:id", getSingleSpace);                      
